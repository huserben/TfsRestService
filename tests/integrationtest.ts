...
describe.skip("Testing newly implemented functionality", () => {
    ...
    const tfsServer: string = "https://benjsawesometfstest.visualstudio.com/DefaultCollection/Build Test";
    ...
    it("get latest failed build and associated changes", async() => {
        ...
        var builds: index.IBuild[] = await tfsRestService.getBuildsByStatus("CI Test", "");
